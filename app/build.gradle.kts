...
val keystorePath = signingValue("MAA_KEYSTORE_PATH", "storeFile")
val keystorePassword = signingValue("MAA_KEYSTORE_PASSWORD", "storePassword")
val keystoreAlias = signingValue("MAA_KEY_ALIAS", "keyAlias")
val keystoreKeyPassword = signingValue("MAA_KEY_PASSWORD", "keyPassword")

android {
    namespace = "io.github.superthom196.maa"
    compileSdk = 37

    defaultConfig {
        applicationId = "io.github.superthom196.maa"
        minSdk = 28
        targetSdk = 36
    ...
    buildTypes {
        release {
            ...
            // it side-loads. Minified to keep the APK small.
